...
class Page2 extends StatefulWidget {
  ...
  String roomName;
  Page2({this.roomName});
  //Page2({Key key, @required this.roomName}) : super(key : key);

  @override
  _MyAppState createState() => _MyAppState(roomName);
}

class _MyAppState extends State<Page2> {
  //var r = Random.secure();
  String roomName;
  _MyAppState(this.roomName);

  final serverText = TextEditingController();
  final roomText = TextEditingController(text: "user-contact");
  //final roomText = TextEditingController(text: roomName);
  final subjectText = TextEditingController(text: "User Meeting");
  final nameText = TextEditingController(text: "Chandu");
  final emailText = TextEditingController(text: "chiranjeevi.chandu@agreat.com");
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Welcome to AZ Video Call'),
        ),
...
/*            floatingActionButton: FloatingActionButton(
                onPressed: () async {
                  var navigationResult = await Navigator.push(
                      context, new MaterialPageRoute(builder: (context) => Icons.add_to_home_screen));*/
        body: Container(
